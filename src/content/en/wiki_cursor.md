...
This is the multi-file editing mode (Cmd+I).
You can say: "Change the return field of this API, and update all frontend component type definitions."
It opens backend, frontend, and type files simultaneously and edits them all. This was unimaginable before.

### 3. Codebase Indexing

It deeply indexes your local codebase. When you ask "Where is the auth logic?", the answer is based on your actual code, not hallucinations.

## Verdict

**"As of now, it is the most stable and balanced choice."**
