...
It reads pixels, not just text.

* **Screenshot to Code**: Draw a sketch or screenshot another app, and it replicates the UI pixel-perfectly.
* **Video Understanding**: Record a screen video saying "Fix this bug," and it understands where you clicked and what went wrong.
...
**"If there were a Nobel Prize for coding, this year's winner is already decided."**
